      ...
      >
        <motion.div variants={item} transition="easeInOut" className="max-w-lg">
          ...
          <p className="py-3 text-lg">
            My first official managerial role came in the shape of the{" "} <em>Head of Web Design</em> for <OutboundLink
              className="text-orange-500 underline hover:text-orange-700"
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.adtrak.co.uk"
            > Adtrak
            </OutboundLink>. Before this, I was part of the Web Design team, and was quickly
          ...
          <div className="flex flex-col my-10 sm:flex-row md:flex-col lg:flex-row max-w-md">
            ...
            <img
              ...
              src={XmasGif}
              className="self-center h-auto w-100 sm:max-w-xs md:max-w-full md:pt-6 lg:max-w-sm lg:p-0 shadow-lg"
            />
          </div>
          ...
          <div className="flex flex-col mt-10 lg:flex-row lg:pt-10 mb-16">
						<div className="lg:w-1/3">
							<p className="pb-4 text-md">
								In 2016, Adtrak's growth opened up an opportunity for an additional support layer below the directors, and I was promoted into the role of a <em>Senior Manager</em>. In this role I was responsible for helping make key decisions on the direction of the company, and overseeing 3 different departments - Web Design, Web Development and Web Leasing. I managed to fulfil this role in addition to being Head of Web Design, until a massive company re-structure redefined my role into the <em>Assistant Customer Operations Director</em>.
							</p>

							<p className="pb-8">Following the global COVID-19 pandemic in 2020, Adtrak went through another difficult re-structure, and a mutual decision put my managerial career with the company on hold, allowing me to focus on front-end development.</p>
						</div>

            <div className="flex flex-col lg:w-2/3 text-empress-500">
              <h2 className="self-end mb-8 md:self-start md:w-3/4 md:ml-auto">Adtrak managerial career</h2>

              <div className="flex flex-row">
                <span className="w-1/4 pr-4 text-empress-600 tracking-widest border-r-2 border-orange-400 border-solid font-heading lg:text-right">
                  2008
                </span>
                <span className="w-3/4 pb-10 pl-4">
                  <span className="text-empress-800">First managerial role</span>
          ...
          <div className="relative mb-10">
            <Img
              ...
              className="max-w-sm mr-auto w-100 xl:max-w-md shadow-lg"
              fluid={props.data.onstageOne.childImageSharp.fluid}
            />

            <p className="z-20 p-8 text-empress-100 border-l-2 border-orange-400 font-heading bg-empress-700 bg-gradient-l-empress-600 sm:absolute sm:top-0 sm:right-0 sm:max-w-xs sm:mt-8 md:text-xl md:top-0 lg:top-0 lg:max-w-sm xl:top-0 xl:text-2xl  shadow-lg">
              Presentation and Q&amp;A for an Adtrak AGM
            </p>

            <Img
              alt="Q and A for an Adtrak AGM"
              className="max-w-sm mb-4 ml-auto w-100 m:-mt-24 lg:-mt-32 xl:-mt-40 shadow-lg"
              fluid={props.data.onstageTwo.childImageSharp.fluid}
            />
          </div>

          <h2 className="mt-4 mb-4 text-3xl text-grey-light">People Management</h2>
          <p className="pb-3 text-lg">
            ...
            people management, including but not limited to;
              ...
              <h3 className="text-empress-800 mb-2">Monthly 1-1s</h3>
              <p className="block mb-6">
                In monthly 1-1s with my direct reports, it has been important to
                have open conversations around how an individual is finding
                their role, and how they can look to improve. I've held 1-1s
                with a vast range of levels of employee, from juniors and
                seniors to department managers and Digital Marketing Managers,
                all of which required a degree of customisation to suit the
                situation and colleague.
              </p>


              <h3 className="text-empress-800 mb-2">Objective setting &amp; KPIs</h3>
              <p className="block mb-6">
                On both an individual and company basis, I have years of
                experience setting SMART objectives and KPIs that are
                achieveable and encourage development and progression.
              </p>


              <h3 className="text-empress-800 mb-2">PIPs, PDPs &amp; Disciplinaries</h3>
              <p className="block mb-6">
          ...
          <p className="pb-3 text-lg">
            ...
            grow and succeed.
					...
					<Img
						...
						className="block w-full mx-auto lg:float-right lg:ml-8 lg:mb-4 lg:mt-8 lg:max-w-96 shadow-lg"
          ...
          <p className="pb-3 text-md">
            Some of my more recent projects delivered include;
              ...
              <h3 className="text-empress-800 mb-2">Customer Journey Plan</h3>
              <p className="block mb-6">
                As part of Adtrak's huge re-structure, a workstream was created
                to devise a full <em>Customer Journey Plan</em>. This involved
                researching Adtrak's current client base by conducting phone
                call interviews and digital surveys, discovering the SME market
                place across the UK and doing competitive analysis. A successful
                plan was delivered to the Adtrak Directors late 2018 and has
                been heavily used in the re-structure of the company.
              </p>

              <h3 className="text-empress-800 mb-2">New products &amp; processes for Adtrak</h3>
              <p className="block mb-6">
                In recent years on seperate occasions I researched solutions for
                Adtrak to offer SSL/HTTPS hosting to its clients - increasing
                the profitability of our hosting product, devising guides and
                resources to streamline the work and ensure our client's
                websites follow encryption guidelines - and found and released a
                solution for Adtrak to deliver sitemaps. Both of these required
                training, guides &amp; discussions to ensure an effective
                release to a company of over 120 people.
              </p>

              <h3 className="text-empress-800 mb-2">"Change for Growth"</h3>
              <p className="block mb-6">
                Adtrak's huge re-structure, dubbed <em>Change for Growth</em>,
                was a huge undertaking, and as part of the leadership team I had
                an integral role in helping direct and deliver the monumental
                change. This included a lot of coaching, supporting and helping
                people through the whole transiton.
              </p>
          ...
          <div className="relative my-10">
            <Img
              ...
              className="block max-w-md mx-auto lg:ml-0 shadow-lg"
              fluid={props.data.leadership.childImageSharp.fluid}
            />

            <p className="z-50 block max-w-lg p-8  shadow-lg mx-auto border-l-2 border-orange-400 bg-empress-700 bg-gradient-l-empress-600 font-heading text-empress-100 lg:absolute lg:bottom-0 lg:right-0 lg:max-w-xs lg:text-xl xl:text-2xl lg:mb-4">
          ...
          <p className="pb-3 text-md">
            ...
            traits;
              ...
              <p className="block mb-6">
								One of the first training sessions I received was identifying my
								own personality type, and learning that of others. My
								personality test revealed my natural inclination toward the
								following;
							</p>
              ...
              <p className="block mb-6">
                ...
                >
                  Tilt 365
								...
								<p>Following another self-completed survey, my Tilt 365 profile
                  returned myself to be <em>Master Mind</em>. Although I accept
                  that my natural persuasion is to think in this way, I believe
                  I am very competent at being able to <em>tilt</em> in to other
                  personality persuasions, dependent on the situation.
                </p>
            ...
            <h3><OutboundLink
              ...
              >
                Situational Leadership
							...
							<p>I've been trained on Situational Leadership, and how changing style depending on the situation can be very effective.</p>
