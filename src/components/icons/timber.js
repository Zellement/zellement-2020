...
const IconTimber = ( {className} ) => {
  return (
    ...
    >
      ...
      >
        <g fill="#1dd186">
          <polygon points="24.6,26.4 23.1,24.4 14.1,24.4 14.1,22.2 21.4,22.2 19.9,20.2 14.1,20.2 14.1,18.1 21.7,18.1 
